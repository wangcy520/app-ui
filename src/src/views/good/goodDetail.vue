            ...
            <div style="background-color: #fff;padding: 20px">
                <div style="display: flex;justify-content: space-between;align-items: center;">
                    <div>
                        ...
                        <span class="redClass1">{{obj.price}}</span>
                        <span class="blackClass">Rp</span>
                        <span class="blackClass">{{obj.vipPrice}}</span>
                ...
                <div class="content_1" style="margin-top: 10px;">
                    <span>Harga Asli:Rp5.000</span>
                    <span>Stok:15581487</span>
                    <span>Terjual:22583705</span>
                </div>
                    ...
                    <div class="popupBox">
                        ...
                        <div class="popupClass">
                            ...
                            <div class="popupClass_right">
                                ...
                                <span  style="color: red;font-size: 16px;">5.000</span>
                                <span style="font-size: 12px;">Inventory: 15581487</span>
                                </div>
